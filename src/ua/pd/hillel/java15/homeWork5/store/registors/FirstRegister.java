 ...
 */
public class FirstRegister extends AbstractRegister implements Runnable {

    private final Cashier cashier;
    private final Queue<Buyer> queue = new LinkedList<>();

    public FirstRegister(Cashier cashier){
    ...
    public void run(){
        ...
        System.out.println("На первой кассе было: " + numberOfCustomers + " покупателей, обслуживание заняло: " + totalTime + " секунд." +
